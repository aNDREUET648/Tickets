 ...
 * @author aNDREUET
 */
public class RegistrarEquipoUsuario extends javax.swing.JFrame {

    int ID_usuario_update = 0;
    String user = "", nom_cliente = "";

    /**
     * Constructor form RegistrarEquipo
     */
    public RegistrarEquipoUsuario() {
        initComponents();
        user = Interface.usuario;
        ID_usuario_update = InformacionUsuario.ID_usuario_update;

        try {
            Connection con = Conexion.conector();
            String sql = "select  nombre, apellidos from Usuarios where "
                    + " idUsuario = '" + ID_usuario_update + "'";
    ...
    private void jButton_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistrarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                pst.setInt(9, ID_usuario_update); // foreign key del id del usuario
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarEquipoUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarEquipoUsuario().setVisible(true);
            }
        });
    }
