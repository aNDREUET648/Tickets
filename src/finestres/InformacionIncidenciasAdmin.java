...
public class InformacionIncidenciasAdmin extends javax.swing.JFrame {
        ...
        try {
            ...
            while (rs.next()) {
                if (rs.getRow() == 1) {
                    ...
                    //fecha_incidente = String.format(strDateFormat,rs.getTimestamp("fecha_crea"));
                    fecha_incidente = rs.getTimestamp("fecha_crea").toString();
                    //fecha_incidente =  DateTimeFormatter.forPattern(strDateFormat).rs.getTimestamp("fecha_crea");
    ...
    private void initComponents() {
        ...
        jLabel_Titulo.setText("Información del Incidente");
        ...
        getContentPane().add(jLabel_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, -1));
        ...
        getContentPane().add(jLabel_Nombre7, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 130, -1, -1));
        ...
        getContentPane().add(jLabel_Nombre8, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 160, -1, -1));
        ...
        getContentPane().add(jLabel_Nombre9, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 190, -1, -1));
        ...
        getContentPane().add(jLabel_Nombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, -1, -1));
        ...
        getContentPane().add(jLabel_Nombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, -1, -1));
        ...
        txt_tipo.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        ...
        getContentPane().add(txt_tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 50, 80, 25));

        txt_idIncidente.setEditable(false);
        txt_idIncidente.setBackground(new java.awt.Color(153, 153, 255));
        txt_idIncidente.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        ...
        txt_fechaincidente.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        ...
        getContentPane().add(txt_fechaincidente, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 50, 220, 25));

        cmb_asignar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item1", "Item2" }));
        getContentPane().add(cmb_asignar, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 130, 300, -1));
        ...
        getContentPane().add(cmb_prioridad, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 160, 80, -1));

        cmb_nivel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Basico", "Tecnico", "Externo" }));
        getContentPane().add(cmb_nivel, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 190, 80, -1));
        ...
        getContentPane().add(jScrollPane_intervenciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 760, 180));
        ...
        getContentPane().add(jButton_Actualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 420, 210, 35));
        ...
        getContentPane().add(jLabel_Nombre4, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 60, -1, -1));
