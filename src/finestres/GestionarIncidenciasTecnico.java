 ...
 * @author aNDREUET
 */
public class GestionarIncidenciasTecnico extends javax.swing.JFrame {
     ...
     */
    public GestionarIncidenciasTecnico() {
        initComponents();
        ...
        try {
            ...
            System.err.println("Error al llenar Histórico de Incidentes Técnico " + e);
            JOptionPane.showMessageDialog(null, "Error al llenar Histórico de Incidentes Técnico, contacte con el Administrador");
        }
        //
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 40, -1, -1));

        jLabel_footer.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_footer.setText("Andreu Garcia Coll - UIB 2020");
        getContentPane().add(jLabel_footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 390, -1, -1));
        ...
        getContentPane().add(jButton_Imprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 330, 80, 80));
    ...
    private void jButton_MostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_MostrarActionPerformed
        ...
        try {
            ...
            System.err.println("Error al recuperar los registros de los Incidentes Técnico " + e);
            JOptionPane.showMessageDialog(null, "Error al recuperar los registros de los Incidentes Técnico, contacte con el Administrador");
        }
        //
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarIncidenciasTecnico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarIncidenciasTecnico().setVisible(true);
            }
        });
    }
